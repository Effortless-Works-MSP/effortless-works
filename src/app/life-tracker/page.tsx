...
import { LIFE_TRACKER_PARENT_META, LIFE_TRACKER_PARENT_SECTION } from '@/lib/pageData'

export const metadata: Metadata = {
  title: 'Life Tracker | Effortless Works',
}
  ...
  return (
    <>
      ...
      <main style={{ minHeight: '100vh', background: '#0C0D0E', position: 'relative', overflow: 'hidden' }}>
        ...
        <PageWrapper>
          <PageHero {...LIFE_TRACKER_PARENT_META} />
          <CourseBanner productName="Life Tracker" />
          <ProductSectionBlock section={LIFE_TRACKER_PARENT_SECTION} index={0} />
          <div style={{ height: 80 }} />
        </PageWrapper>
      </main>
      <Footer />
