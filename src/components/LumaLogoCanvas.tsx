...
interface LumaLogoCanvasProps {
  ...
  transparent?: boolean // true = no background (blends with parent card)
}

export default function LumaLogoCanvas({ size = 240, animated = true, transparent = false }: LumaLogoCanvasProps) {
  ...
  useEffect(() => {
    ...
    if (!transparent) renderer.setClearColor(BG, 1)
