...
import { P_SELFPACED_META, P_SELFPACED_SECTION } from '@/lib/pageData'
import ParallaxStars from '@/components/ui/ParallaxStars'

export const metadata: Metadata = {
  title: 'Self Paced Courses · Individuals | Effortless Works',
}
  ...
  return (
    <>
      ...
      <main style={{ minHeight: '100vh', background: '#0C0D0E', position: 'relative', overflow: 'hidden' }}>
        ...
        <PageWrapper>
           <PageHero {...P_SELFPACED_META} />
          <ProductSectionBlock section={P_SELFPACED_SECTION} index={0} />
          <div style={{ height: 80 }} />
        </PageWrapper>
      </main>
      <Footer />
